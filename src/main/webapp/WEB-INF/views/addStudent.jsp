...
<nav class="navbar">
  ...
  <div class="navbar-links" id="navLinks">
    ...
    <a href="addStudent" class="active">Add Student</a>
...
<div class="page">
  ...
  <div class="breadcrumb">
    ...
    <a href="viewStudents">All Students</a>
    <span class="breadcrumb-sep">›</span>
    <span class="breadcrumb-current">Add Student</span>
  </div>

  <div class="page-header">
    <div>
      <h1 class="page-title">Add New Student</h1>
      <p class="page-title-sub">Register a new student record in the system</p>
    </div>
  ...
  <% if (request.getAttribute("error") != null) { %>
    <div class="alert alert-error" style="margin-bottom:24px;">
      ...
      <div class="alert-body"><%= request.getAttribute("error") %></div>
    </div>
  <% } %>
      ...
      <div class="form-body">
        <div class="form-grid">
          <div class="field">
            ...
            <input type="text" name="name" value="${name}" placeholder="e.g. Aditya Sharma" required>
          </div>
          <div class="field">
            <label class="field-required">Email Address</label>
            <input type="email" name="email" value="${email}" placeholder="e.g. aditya@greenfield.edu" required>
          </div>
          <div class="field">
            <label class="field-required">Phone Number</label>
            <input type="text" name="phone" value="${phone}" placeholder="e.g. 9876543210" required>
          </div>
          <div class="field">
            <label class="field-required">Course / Programme</label>
            <input type="text" name="course" value="${course}" placeholder="e.g. Computer Science" required>
          </div>
          <div class="field">
            <label class="field-required">Marks Obtained (0 – 100)</label>
            <input type="number" name="marks" value="${marks}" step="0.01" min="0" max="100" placeholder="e.g. 87.5" required>
            <div class="field-hint">Enter percentage marks up to two decimal places.</div>
          </div>
        </div>
      </div>
